...
В примерах, в которых применяется элемент widget, обеспечивающий интерактивность, графики при предварительном просмотре не отображаются. Для полноценного взаимодействия необходимо выполнить одно из действий на выбор:
- установить программу Anaconda c Jupiter Notebook, согласно инструкции ниже;
- открыть jupiter notebook online в предварительном просмотре на сервисе nbviewer (кнопка Execute on Binder в правом верхнем углу).
